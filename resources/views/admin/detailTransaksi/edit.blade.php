    ...
    <div class="content-page">
        <div class="content">
            <h4 class="fw-bold py-3 mb-4">
                <span class="text-muted fw-light">Tabel /</span> Edit Detail Transaksi
            </h4>
            <div class="row">
                <div class="col-12">
                    <div class="card">
                        ...
                        <div class="card-body">
                            <form action="{{ route('dettransaksi.update', $detailTransaksi->id) }}" method="POST">
                                @csrf
                                @method('PUT')
                                <div class="row mb-3">
                                ...
                                <div class="row-content-end">
                                    <div class="col-sm-10">
                                        <a href="{{ route('dettransaksi.index') }} " class="btn btn-primary">Cancel</a>
