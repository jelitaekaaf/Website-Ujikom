            ...
            <div class="content-page">
                <div class="content">
                    ...
                    <div class="container-fluid">
                        <h4 class="fw-bold py-3 mb-4"><span class="text-muted fw-light">Laporan /</span> Barang Masuk</h4>
                        <div class="row">
                            <div class="col-md-12">
                                <div class="card overflow-hidden mb-0">
                                    <div class="card-header">
                                        <div class="d-flex flex-wrap align-items-center gap-2">
                                            <h5 class="card-title text-black mb-0 me-auto">Barang Masuk</h5>

                                            <form action="{{ route('laporan.barangMasuk') }}" method="GET" class="d-flex align-items-center gap-2">
                                                <div class="input-group">
                                                    <span class="input-group-text bg-white"><i class="bi bi-calendar-date text-primary"></i></span>
                                                    <input type="date" name="tanggal" class="form-control rounded-end" value="{{ request('tanggal') }}">
                                                </div>
                                            ...
                                            <button onclick="printTable()" class="btn btn-secondary ms-2">🖨 Print</button>
                                        </div>
