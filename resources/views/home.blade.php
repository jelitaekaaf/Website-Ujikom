...
<html lang="en">
    <head>
        ...
        <style>
            .custom-shadow {
              box-shadow: 0 4px 12px #a8e6cf !important; /* Shadow ungu */
              transition: box-shadow 0.3s ease;
            }

            .custom-shadow:hover {
              box-shadow: 0 6px 18px #a8e6cf !important; /* Hover effect */
            }
          </style>
        ...
        <div id="app-layout">
                    ...
                    <div class="container-fluid">
                        <div class="py-3 d-flex align-items-sm-center flex-sm-row flex-column">
                            <div class="flex-grow-1">
                                <h5 class="fs-18 fw-semibold m-0">Beranda</h5>
                            </div>
                        </div>
                        <div class="col mb-4" >
                         <!-- Tambahkan animasi dengan class dan style -->
                         <div class="card custom-shadow" style="background-color: #ffffff; border-radius: 10px; padding: 10px;">
                            <div class="card-body">
                              <div class="d-flex align-items-center">
                                <div class="flex-grow-1">
                                  ...
                                  <h4 class="card-title mb-2">Selamat Datang di Dashboard Anda!</h4>
                                  <a href="profile" class="btn btn-outline-primary fw-bold">Lihat Profile</a>
                                </div>
                                <div>
                                  <img src="assets/images/man.png" alt="Ilustrasi" style="max-width: 120px; border-radius: 20px;">
                                </div>
                              </div>
                            </div>
                          </div>
                                                    ...
                                                    @forelse($stokTipis as $barang)
                                                        <tr>
                                                            ...
                                                            <td>
                                                                ...
                                                                <a href="{{ route('barang.index', $barang->id) }}" class="btn btn-sm btn-outline-primary rounded-pill px-3">
                                                                    Lihat Detail
                                                                </a>
                                                            </td>
            ...
            <script>
                ...
                new Chart(kategoriCtx, {
                    type: 'pie',
                    data: {
                        labels: ['Elektronik', 'ATK', 'Pakaian', 'Perabotan dan Alat Rumah Tangga','Peralatan Keamanan',
                        'Suku Cadang / Sparepart','Peralatan Kebersihan','Peralatan Medis','Obat-obatan','Skincare'],
                        datasets: [{
                            data: [30, 20, 25, 25, 30, 20, 25, 25, 15, 10],
                            backgroundColor: ['#4bc0c0', '#ff9f40', '#ff6384', '#36a2eb', '#4bc0c0',
                            '#ff9f40', '#ff6384', '#36a2eb', '#36a2eb', '#4bc0c0',],
                        }]
                    },
                    options: {
                        responsive: true
