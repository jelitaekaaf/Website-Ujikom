                ...
                <div class="content">
                    <div class="container-fluid">
                        ...
                        <div class="col mb-4" >
                         ...
                         <div class="card shadow" style="background-color: white; border-radius: 10px; padding: 10px;">
                            <div class="card-body">
                                <div class="d-flex align-items-center">
                                    <div class="flex-grow-1">
                                        <h4 class="card-title mb-2" style="color: #2e7d32;"><b>Hello  {{Auth::user()->name}} 👋🏻</b></h4>
