                                        ...
                                        <div class="widget-first">
                                            <div class="d-flex justify-content-between align-items-end">
                                                <div>
                                                    <div class="d-flex align-items-center mb-3">
                                                        ...
                                                        <p class="mb-0 text-dark fs-15" >Pembelian</p>
                                                    </div>
                                                    <h3 class="mb-0 fs-24 text-black me-2">1 Items</h3>
                                                </div>
                                            ...
                                            <div>
                                                <p class="text-muted mb-0 fs-13">
                                                    ...
                                                    <small class="text-dark fs-14"> Pembelian Hari Ini </small>
                                                </p>
                                            </div>
                                        </div>
                                    </div>
                                        ...
                                        <div class="widget-first">
                                            <div class="d-flex justify-content-between align-items-end">
                                                <div>
                                                    <div class="d-flex align-items-center mb-3">
                                                        ...
                                                        <p class="mb-0 text-dark-bold fs-15"><a href="barang_masuk">Barang Masuk</a></p>
                                                    </div>
                                                    <h3 class="mb-0 fs-24 text-black me-2">1 Items</h3>
                                                </div>
                                            ...
                                            <div>
                                                <p class="text-muted mb-0 fs-13">
                                                    ...
                                                    <small class="text-dark fs-14"> Barang Masuk Hari Ini </small>
                                                </p>
                                            </div>
                                    ...
                                    <div class="card-body">
                                        <div class="widget-first">
                                            <div class="d-flex justify-content-between align-items-end">
                                                <div>
                                                    <div class="d-flex align-items-center mb-3">
                                                        ...
                                                        <p class="mb-0 text-dark fs-15">Barang Keluar</p>
                                                    </div>
                                                    <h3 class="mb-0 fs-24 text-black me-2">1 Items</h3>
                                                </div>
                                            ...
                                            <div>
                                                <p class="text-muted mb-0 fs-13">
                                                    <span class="text-primary fs-14 me-2"><i class="mdi mdi-trending-up fs-18"></i> </span>
                                                    <small class="text-dark fs-14"> Barang Keluar Hari Ini </small>
                                                </p>
                                            </div>
                                    ...
                                    <div class="card-body">
                                        <div class="widget-first">
                                            <div class="d-flex justify-content-between align-items-end">
                                                <div>
                                                    <div class="d-flex align-items-center mb-3">
                                                        ...
                                                        <p class="mb-0 text-dark fs-15">Stok </p>
                                                    </div>
                                                    <h3 class="mb-0 fs-24 text-black me-2">1 Items</h3>
                                                </div>
                                            ...
                                            <div>
                                                <p class="text-muted mb-0 fs-13">
                                                    <span class="text-primary fs-14 me-2"><i class="mdi mdi-trending-up fs-18"></i> </span>
                                                    <small class="text-dark fs-14"> Stok Barang Hari Ini </small>
                                                </p>
                                            </div>
